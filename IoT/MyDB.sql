...
--
-- Host: localhost
-- Generation Time: Jun 15, 2018 at 07:39 PM
...
--
-- Table structure for table `lastorder`
--
...
--
-- Dumping data for table `lastorder`
--

INSERT INTO `lastorder` (`Product_ID`, `Product_Description`, `Product_Price`, `Order_Quantity`) VALUES
(1, ' 	Kitekat-Katzenfutter', 9.57, 0),
(2, 'Duracell Plus Power AAA Batterien ', 15.99, 0);
...
--
-- AUTO_INCREMENT for table `lastorder`
--
ALTER TABLE `lastorder`
...
--
ALTER TABLE `Test`
  MODIFY `Nr` int(128) NOT NULL AUTO_INCREMENT;
--
-- Database: `phpmyadmin`
--
...
('root', '2018-06-15 17:39:23', '{\"Console\\/Mode\":\"show\",\"Console\\/Height\":255}');
